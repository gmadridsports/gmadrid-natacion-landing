                ...
                >
                    <div className="xl:max-w-xl">
                        ...
                        <p className="mt-2 text-gray-600 sm:mt-4 sm:text-xl">
                            Casi estás. Para acceder a la aplicación, <a href={`https://gmadridnatacion.bertamini.net/login-callback`}>pincha aquí</a> o <a href="net.bertamini.gmadridnatacion://login-callback">aquí</a> .
                        </p>
